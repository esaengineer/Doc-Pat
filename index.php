		      					...
		      					<table class="table table-striped table-bordered">
		      						...
		      						foreach($result as $row)
		      						{
		      							...
		      							<tr>
		      								...
		      								<td><button type="button" name="get_appointment" class="btn button-18 btn-primary btn-sm get_appointment" data-id="'.$row["doctor_schedule_id"].'">Get Appointment</button></td>
		      							</tr>
		      							';
		      						}
		      						?>
