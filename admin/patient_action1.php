...
// echo ($_POST['action']);
	...
	// 		// else
	// 		// {
	// 		// 	$character = $_POST["patient_first_name"][0];
	...
	// 				':patient_name'					=>	$object->clean_input($_POST["patient_first_name"]),
	...
	// 			// VALUES (:patient_email_address, :patient_password, :patient_first_name, :patient_profile_image, :patient_phone_no, :patient_address, :patient_date_of_birth, :patient_degree, :patient_expert_in, :patient_status, :patient_added_on)
	// 			// ";


	// 			$object->query = "
	// 			INSERT INTO patient_table 
	// 			(patient_email_address, patient_password, patient_name, patient_phone_no, patient_address, patient_date_of_birth, patient_status, patient_added_on) 
	// 			VALUES (:patient_email_address, :patient_password, :patient_first_name, :patient_phone_no, :patient_address, :patient_date_of_birth, :patient_status, :patient_added_on)
	// 			";
		...
		// {
			...
			if($error == '')
			{
				$data = array(
					':patient_email_address'			=>	$object->clean_input($_POST["patient_email_address"]),
					':patient_password'				=>	$_POST["patient_password"],
					':patient_first_name'					=>	$object->clean_input($_POST["patient_firstname"]),
					':patient_last_name'					=>	$object->clean_input($_POST["patient_lastname"]),
				...
				$object->query ="INSERT INTO patient_table 
				(patient_email_address, patient_password, patient_first_name, patient_last_name, patient_phone_no, patient_address, patient_date_of_birth, patient_status, patient_added_on) 
				VALUES (:patient_email_address, :patient_password, :patient_first_name, :patient_lastname ,:patient_phone_no, :patient_address, :patient_date_of_birth, :patient_status, :patient_added_on)";
	...
	if($_POST["action"] == 'Edit')
	{
		...
		else
		{
			...
			if($error == '')
			{
				...
				patient_degree = :patient_degree,  
				patient_expert_in = :patient_expert_in 
