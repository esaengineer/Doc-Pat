...
<?php
// echo "Testing";//Entry Point For Admin


include('../class/Appointment.php');

$object = new Appointment;
// echo(String.valueOf(new Appointment));
...
<body class="text-center">
    <main class="form-signin">
         <form method="post" id="login_form">
            ...
            <div class="form-group">
                <button type="submit" name="login_button" id="login_button" class="btn button-18 btn-primary btn-user btn-block">Login</button>
            </div>
        </form>
    </main>
