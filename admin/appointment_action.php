...
if(isset($_POST["action"]))
{
	if($_POST["action"] == 'fetch')
	{
		...
		{
			$order_column = array('appointment_table.appointment_number', 'patient_table.patient_name', 'doctor_table.doctor_name', 'doctor_schedule_table.doctor_schedule_date', 'appointment_table.appointment_time', 'doctor_schedule_table.doctor_schedule_day', 'appointment_table.status');
			$main_query = "
			...
			if(isset($_POST["search"]["value"]))
			{
				...
				$search_query .= 'OR patient_table.patient_name LIKE "%'.$_POST["search"]["value"].'%" ';
		...
		{
			$order_column = array('appointment_table.appointment_number', 'patient_table.patient_name', 'doctor_schedule_table.doctor_schedule_date', 'appointment_table.appointment_time', 'doctor_schedule_table.doctor_schedule_day', 'appointment_table.status');
		...
		foreach($appointment_data as $appointment_row)
		{
			...
			foreach($patient_data as $patient_row)
			{
				...
				<tr>
					...
					<td>'.$patient_row["patient_name"].'</td>
				</tr>
				<tr>
